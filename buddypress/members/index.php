  ...
  ?>
    ...
    <div class="screen-content">
        ...
        <div class="top-blue-bar">
            <article class="">
                <h5 class="page-header-title text-light pt-3 font-weight-bold" style="padding-left: 1.8rem;">
                    Athletes
                </h5>
        ...
        <div class="top-filter-navbar-index">
            ...
            <section class="top-page-menu clearfix">
                <h3 class="menu-title float-left pt-1" style="font-size: 1.2rem;">Filters</h3>
            ...
            <section class="top-page-menu clearfix">
                <div class="row top-row">
                    <div class="col-md-2">
                        ...
                        <h3 id="adv-filter-main-title" class="menu-title float-left pt-2 text-light">Advance Filters
                        </h3>
                ...
                <div class="row bottom-row">
                    ...
                    <div class="col-md-10">
                        <ul class="list-inline menu-box menu-box-sports menu-box-GOLF">
                            ...
                            <a class="moose-item select-filter  back-to-filters" href="#">
                                <li class="list-inline-item">
